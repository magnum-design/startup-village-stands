...
const pageData = {
    ...
    packaging_button: {
        ...
        indicator: [
            {"300+":"заявок подано на участие в программе"},
    ...
    grants_button: {
        ...
        indicator: [
            {"300": "заявок подано"},
            {"300":"заявок одобрено"},
            {"300":"на 1 компанию в год (сумма оказанной поддержки) hdgfhgifdyuh hvgdbjbdfj  sfhbfiushifgu sufhsuikhfksuhf sfhsodihf"},
            {"300":"сумма оказанной поддержки (за все время)"},
        ],
        title: "Оценка инвестиционной готовности",
        text: [
            { 'Базар': 'Глубокий анализ отрасли, оценка трендов и перспектив роста в выбранной нише' },
