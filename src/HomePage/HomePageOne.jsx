...
const pageData = {
    ...
    packaging_button: {
        ...
        indicator: [
            {"<h3 class='indicator_size'>300+</h3>":"заявок подано на участие в программе"},
            {"300+":"сумма привлеченного финансирования"},
    ...
    grants_button: {
        ...
        indicator: [
            {"<h3 class='indicator_size'>300</h3>": "заявок подано"},
            {"<h3 class='indicator_size'>300</h3>":"заявок одобрено"},
            {"<h3 class='indicator_size'>300</h3>":"на 1 компанию в год (сумма оказанной поддержки) hdgfhgifdyuh hvgdbjbdfj  sfhbfiushifgu sufhsuikhfksuhf sfhsodihf"},
            {"<h3 class='indicator_size'>300</h3>":"сумма оказанной поддержки (за все время)"},
        ],
        title: "Оценка инвестиционной готовности",
        text: [
            { 'Базар': 'Глубокий анализ отрасли, оценка трендов и перспектив роста в выбранной нише' },
